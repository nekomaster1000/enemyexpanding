...
public class Modelsenior_zombie<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "senior_zombie"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(51, 51)
				.addBox(-5.4F, 0.0F, -2.0F, 8.0F, 18.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.5F, 6.0F, 0.0F));

		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(49, 0).mirror()
						.addBox(-2.6F, 0.0F, -2.0F, 8.0F, 18.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(2.5F, 6.0F, 0.0F));

		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 58)
		...
		PartDefinition Body_r1 = Body
				.addOrReplaceChild("Body_r1",
						CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -20.0F, -5.0F, 16.0F, 20.0F, 8.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 1.0F, 0.4363F, 0.0F, 0.0F));

		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(29, 29)
						.addBox(-6.0F, -2.0F, -2.0F, 6.0F, 20.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(58, 31)
