...
**/
public class BullModelProcedure extends AnimatedGeoModel<BullEntity> {
	@Override
	...
	public ResourceLocation getTextureLocation(BullEntity entity) {
		return new ResourceLocation("enemyexpansion", "textures/entities/bull.png");
	}

	@Override
	public void setCustomAnimations(BullEntity animatable, int instanceId, AnimationEvent animationEvent) {
