...
**/
public class PetrimanModelProcedure extends AnimatedGeoModel<PetrimanEntity> {
	@Override
	...
	public ResourceLocation getTextureLocation(PetrimanEntity entity) {
		return new ResourceLocation("enemyexpansion", "textures/entities/petriman.png");
	}

	@Override
	public void setCustomAnimations(PetrimanEntity animatable, int instanceId, AnimationEvent animationEvent) {
