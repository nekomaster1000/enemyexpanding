...
**/
public class GallantModelProcedure extends AnimatedGeoModel<GallantEntity> {
	@Override
	...
	public ResourceLocation getTextureLocation(GallantEntity entity) {
		return new ResourceLocation("enemyexpansion", "textures/entities/gallant.png");
	}

	@Override
	public void setCustomAnimations(GallantEntity animatable, int instanceId, AnimationEvent animationEvent) {
