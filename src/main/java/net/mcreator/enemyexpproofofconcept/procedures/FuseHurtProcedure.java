							...
							if (entity instanceof CrawlerEntity && !world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3((entity.getX()), (entity.getY()), (entity.getZ())), 6, 6, 6), e -> true).isEmpty()) {
								...
								if (world instanceof ServerLevel _level)
									_level.getServer().getCommands()
											.performCommand(new CommandSourceStack(CommandSource.NULL, new Vec3((entity.getX()), (entity.getY() + 0.5), (entity.getZ())), Vec2.ZERO, _level, 4, "", new TextComponent(""), _level.getServer(), null)
													.withSuppressedOutput(), "/summon enemyexpansion:invisicreeper ~ ~ ~ {Silent:1b,NoAI:1b,Health:1f,Fuse:1,ignited:1b,ExplosionRadius:4b,CustomName:'{\"text\":\"Intruder\"}'}");
							}
						}
