...
public class PetrimanReplacementProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((world.getLevelData().getGameRules().getInt(EnemyexpansionModGameRules.PETRIMANREPLACEMENTRULE)) > 0) {
			if (entity instanceof Zombie && entity.getY() < 25) {
				new Object() {
					private int ticks = 0;
