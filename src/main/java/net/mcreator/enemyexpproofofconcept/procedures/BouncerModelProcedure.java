...
**/
public class BouncerModelProcedure extends AnimatedGeoModel<BouncerEntity> {
	@Override
	...
	public ResourceLocation getTextureLocation(BouncerEntity entity) {
		return new ResourceLocation("enemyexpansion", "textures/entities/goblin_bouncer.png");
	}

	@Override
	public void setCustomAnimations(BouncerEntity animatable, int instanceId, AnimationEvent animationEvent) {
