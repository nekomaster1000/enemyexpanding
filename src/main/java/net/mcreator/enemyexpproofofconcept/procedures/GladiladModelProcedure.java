...
**/
public class GladiladModelProcedure extends AnimatedGeoModel<GladiladEntity> {
	@Override
	...
	public ResourceLocation getTextureLocation(GladiladEntity entity) {
		return new ResourceLocation("enemyexpansion", "textures/entities/gladilad.png");
	}

	@Override
	public void setCustomAnimations(GladiladEntity animatable, int instanceId, AnimationEvent animationEvent) {
