...
**/
public class RamModelProcedure extends AnimatedGeoModel<RamEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(RamEntity animatable, int instanceId, AnimationEvent animationEvent) {
