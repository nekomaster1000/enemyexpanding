...
public class ScorpionReplaceProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((world.getLevelData().getGameRules().getInt(EnemyexpansionModGameRules.SCORPIONREPLACEMENTRULE)) > 0) {
			if (entity instanceof Spider && (new ResourceLocation("desert").equals(world.getBiome(new BlockPos(x, y, z)).value().getRegistryName())
