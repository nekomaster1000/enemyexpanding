...
**/
public class ZobgoblinModelProcedure extends AnimatedGeoModel<ZobgoblinEntity> {
	@Override
	...
	public ResourceLocation getTextureLocation(ZobgoblinEntity entity) {
		return new ResourceLocation("enemyexpansion", "textures/entities/zobgoblin.png");
	}

	@Override
	public void setCustomAnimations(ZobgoblinEntity animatable, int instanceId, AnimationEvent animationEvent) {
