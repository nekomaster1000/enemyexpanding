...
public class CrawlerReplacementProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((world.getLevelData().getGameRules().getInt(EnemyexpansionModGameRules.CRAWLERREPLACEMENTRULE)) > 0) {
			if (entity instanceof Creeper && entity.getY() < -15) {
				new Object() {
					private int ticks = 0;
