...
**/
public class FrigidModelProcedure extends AnimatedGeoModel<FrigidEntity> {
	@Override
	...
	public ResourceLocation getTextureLocation(FrigidEntity entity) {
		return new ResourceLocation("enemyexpansion", "textures/entities/frigid.png");
	}

	@Override
	public void setCustomAnimations(FrigidEntity animatable, int instanceId, AnimationEvent animationEvent) {
