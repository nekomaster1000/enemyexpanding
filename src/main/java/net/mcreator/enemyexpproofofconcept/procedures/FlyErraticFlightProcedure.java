...
public class FlyErraticFlightProcedure {
	public static void execute(Entity entity) {
		...
		if (Math.random() < 0.01) {
			...
			entity.setDeltaMovement(new Vec3((Mth.nextDouble(RandomSource.create(), -0.4, 0.4)), (Mth.nextDouble(RandomSource.create(), -1, 0.2)), (Mth.nextDouble(RandomSource.create(), -0.4, 0.4))));
		}
	}
}
