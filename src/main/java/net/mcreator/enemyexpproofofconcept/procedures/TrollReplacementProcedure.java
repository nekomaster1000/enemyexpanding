...
public class TrollReplacementProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((world.getLevelData().getGameRules().getInt(EnemyexpansionModGameRules.TROLLREPLACEMENTRULE)) > 0) {
			if (entity instanceof EnderMan && entity.getY() < -20) {
				new Object() {
					private int ticks = 0;
