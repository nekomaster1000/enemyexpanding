...
**/
public class PetrifiedtrollModelProcedure extends AnimatedGeoModel<PetrifiedtrollEntity> {
	@Override
	...
	public ResourceLocation getTextureLocation(PetrifiedtrollEntity entity) {
		return new ResourceLocation("enemyexpansion", "textures/entities/troll_stone.png");
		/**
		}
		@Override
		public void setCustomAnimations(PetrifiedtrollEntity animatable, int instanceId, AnimationEvent animationEvent) {
