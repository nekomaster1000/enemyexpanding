...
**/
public class BanedasherModelProcedure extends AnimatedGeoModel<BanedasherEntity> {
	@Override
	...
	public ResourceLocation getTextureLocation(BanedasherEntity entity) {
		return new ResourceLocation("enemyexpansion", "textures/entities/banedasher.png");
	}

	@Override
	public void setCustomAnimations(BanedasherEntity animatable, int instanceId, AnimationEvent animationEvent) {
