...
**/
public class PheromoneSummonModelProcedure extends AnimatedGeoModel<PheromoneSummonEntity> {
	@Override
	...
	public ResourceLocation getTextureLocation(PheromoneSummonEntity entity) {
		return new ResourceLocation("enemyexpansion", "textures/entities/wasp_drone.png");
	}

	@Override
	public void setCustomAnimations(PheromoneSummonEntity animatable, int instanceId, AnimationEvent animationEvent) {
