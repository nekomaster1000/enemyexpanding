...
public class IntruderReplacementProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((world.getLevelData().getGameRules().getInt(EnemyexpansionModGameRules.INTRUDERREPLACEMENTRULE)) > 0) {
			if (entity instanceof Creeper && entity.getY() < 25 && entity.getY() > -15) {
				new Object() {
					private int ticks = 0;
