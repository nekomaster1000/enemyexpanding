...
**/
public class WolfsbaneModelProcedure extends AnimatedGeoModel<WolfsbaneEntity> {
	@Override
	...
	public ResourceLocation getTextureLocation(WolfsbaneEntity entity) {
		return new ResourceLocation("enemyexpansion", "textures/entities/wolfsbane.png");
	}

	@Override
	public void setCustomAnimations(WolfsbaneEntity animatable, int instanceId, AnimationEvent animationEvent) {
