		...
		if (entity.isAlive()) {
			...
			if (sourceentity instanceof Player) {
				...
				new Object() {
					...
					private void run() {
						if (Math.random() < 0.5) {
							entity.setDeltaMovement(new Vec3((-4), (Mth.nextDouble(new Random(), 0, 1)), (Mth.nextDouble(new Random(), -2, 2))));
						} else {
							entity.setDeltaMovement(new Vec3(4, (Mth.nextDouble(new Random(), 0, 1)), (Mth.nextDouble(new Random(), -2, 2))));
						}
			...
			if ((world.getBlockState(new BlockPos(sourceentity.getX() - Mth.nextDouble(new Random(), -8, 8), sourceentity.getY() - 1, sourceentity.getZ() - Mth.nextDouble(new Random(), -8, 8)))).getBlock() == Blocks.WATER) {
				...
				new Object() {
					...
					private void run() {
						for (int index0 = 0; index0 < (int) (Mth.nextDouble(new Random(), 1, 2)); index0++) {
							if (world instanceof ServerLevel _serverLevelForEntitySpawn) {
								...
								_entityForSpawning.moveTo((sourceentity.getX() - Mth.nextDouble(new Random(), -8, 8)), (sourceentity.getY() - 1), (sourceentity.getZ() - Mth.nextDouble(new Random(), -8, 8)), world.getRandom().nextFloat() * 360F, 0);
								if (world instanceof Level _level) {
									if (!_level.isClientSide()) {
