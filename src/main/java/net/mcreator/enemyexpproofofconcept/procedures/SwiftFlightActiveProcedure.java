	...
	public static void execute(Entity entity) {
		...
		entity.setDeltaMovement(new Vec3(
				(Math.sin(Math.toRadians(entity.getYRot() + 180)) * 1.5
						* (0.1 + (entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(EnemyexpansionModMobEffects.SWIFT_FLIGHT.get()) ? _livEnt.getEffect(EnemyexpansionModMobEffects.SWIFT_FLIGHT.get()).getAmplifier() : 0) / 5)),
