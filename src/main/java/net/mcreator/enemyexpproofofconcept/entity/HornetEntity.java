...
public class HornetEntity extends Monster implements IAnimatable {
	...
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(HornetEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(HornetEntity.class, EntityDataSerializers.STRING);
	...
	public HornetEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EnemyexpansionModEntities.HORNET.get(), world);
	}

	public HornetEntity(EntityType<HornetEntity> type, Level world) {
		super(type, world);
		xpReward = 5;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "hornet");
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(10, new NearestAttackableTargetGoal(this, Bee.class, false, false));
	...
	public boolean hurt(DamageSource source, float amount) {
		HornetDodgePatternProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(HornetEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
