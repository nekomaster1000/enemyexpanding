...
public class BouncerEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(BouncerEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(BouncerEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(BouncerEntity.class, EntityDataSerializers.STRING);
	...
	public BouncerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EnemyexpansionModEntities.BOUNCER.get(), world);
	}

	public BouncerEntity(EntityType<BouncerEntity> type, Level world) {
		super(type, world);
		xpReward = 20;
		setNoAi(false);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "goblin_bouncer");
	}
	...
	public static void init() {
		DungeonHooks.addDungeonMob(EnemyexpansionModEntities.BOUNCER.get(), 180);
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BouncerEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
