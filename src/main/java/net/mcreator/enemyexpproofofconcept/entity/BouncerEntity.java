...
public class BouncerEntity extends Monster implements IAnimatable {
	...
	private static final Set<ResourceLocation> SPAWN_BIOMES = Set.of(new ResourceLocation("stony_shore"), new ResourceLocation("windswept_hills"),
			new ResourceLocation("taiga"), new ResourceLocation("windswept_gravelly_hills"), new ResourceLocation("snowy_taiga"));

	@SubscribeEvent
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.MONSTER)
					.add(new MobSpawnSettings.SpawnerData(EnemyexpansionModEntities.BOUNCER.get(), 10, 1, 3));
	}
	...
	public static void init() {
		SpawnPlacements.register(EnemyexpansionModEntities.BOUNCER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
