...
public class EyestalkerEntity extends Monster implements IAnimatable {
	...
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(EyestalkerEntity.class, EntityDataSerializers.STRING);
	...
	public EyestalkerEntity(EntityType<EyestalkerEntity> type, Level world) {
		super(type, world);
		xpReward = 10;
		setNoAi(false);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "eyestalker");
	}
	...
	public void baseTick() {
		super.baseTick();
		EyestalkerTickProcedure.execute(this);
	...
	public static void init() {
		SpawnPlacements.register(EnemyexpansionModEntities.EYESTALKER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(EyestalkerEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
