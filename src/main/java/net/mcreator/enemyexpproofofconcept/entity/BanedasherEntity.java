...
import net.mcreator.enemyexpproofofconcept.procedures.BanedasherHurtProcedure;
...
public class BanedasherEntity extends Monster implements IAnimatable {
	...
	public boolean hurt(DamageSource source, float amount) {
		BanedasherHurtProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this, source.getEntity());
