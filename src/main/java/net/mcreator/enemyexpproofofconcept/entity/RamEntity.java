...
public class RamEntity extends Monster implements IAnimatable {
	...
	private static final Set<ResourceLocation> SPAWN_BIOMES = Set.of(new ResourceLocation("windswept_hills"), new ResourceLocation("taiga"),
			new ResourceLocation("stony_peaks"), new ResourceLocation("snowy_slopes"), new ResourceLocation("windswept_gravelly_hills"),
			new ResourceLocation("frozen_peaks"), new ResourceLocation("snowy_taiga"), new ResourceLocation("jagged_peaks"));
