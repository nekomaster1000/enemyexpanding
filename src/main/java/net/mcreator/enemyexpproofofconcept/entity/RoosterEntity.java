...
public class RoosterEntity extends Animal implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(RoosterEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(RoosterEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(RoosterEntity.class, EntityDataSerializers.STRING);
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(EnemyexpansionModEntities.ROOSTER.get(), 15, 1, 5));
	}

	public RoosterEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EnemyexpansionModEntities.ROOSTER.get(), world);
	}

	public RoosterEntity(EntityType<RoosterEntity> type, Level world) {
		super(type, world);
		xpReward = 3;
		setNoAi(false);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "rooster");
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, Fox.class, false, false));
		this.targetSelector.addGoal(7, new NearestAttackableTargetGoal(this, Wolf.class, false, false));
		this.targetSelector.addGoal(8, new NearestAttackableTargetGoal(this, Ocelot.class, false, false));
	...
	public void baseTick() {
		super.baseTick();
		RoosterFlapProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		RoosterEntity retval = EnemyexpansionModEntities.ROOSTER.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(EnemyexpansionModEntities.ROOSTER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(RoosterEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
