...
public class FrigidEntity extends Zombie implements IAnimatable {
	...
	private static final Set<ResourceLocation> SPAWN_BIOMES = Set.of(new ResourceLocation("grove"), new ResourceLocation("windswept_hills"),
			new ResourceLocation("snowy_plains"), new ResourceLocation("snowy_slopes"), new ResourceLocation("frozen_peaks"),
			new ResourceLocation("snowy_taiga"), new ResourceLocation("snowy_beach"));

	@SubscribeEvent
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.MONSTER)
					.add(new MobSpawnSettings.SpawnerData(EnemyexpansionModEntities.FRIGID.get(), 120, 1, 2));
	}
