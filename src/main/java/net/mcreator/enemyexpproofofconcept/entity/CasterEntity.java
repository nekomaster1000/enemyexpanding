...
public class CasterEntity extends Monster implements RangedAttackMob, IAnimatable {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(4, new AvoidEntityGoal<>(this, Player.class, (float) 4, 1.2, 1.6));
		...
		this.targetSelector.addGoal(8, new NearestAttackableTargetGoal(this, ZombieVillager.class, false, false));


		
		this.goalSelector.addGoal(10, new RandomStrollGoal(this, 1));
		this.goalSelector.addGoal(11, new LeapAtTargetGoal(this, (float) 0.45));
		this.goalSelector.addGoal(12, new RandomLookAroundGoal(this));
		this.goalSelector.addGoal(13, new FloatGoal(this));
		this.goalSelector.addGoal(14, new RandomSwimmingGoal(this, 8, 140));

		this.goalSelector.addGoal(9, new RangedAttackGoal(this, 1, 40, 20) {
			@Override
