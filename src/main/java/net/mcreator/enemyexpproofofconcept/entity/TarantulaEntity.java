...
import net.mcreator.enemyexpproofofconcept.procedures.TarantulaEntityIsHurtProcedure;
...
public class TarantulaEntity extends Spider implements IAnimatable {
	...
	private static final Set<ResourceLocation> SPAWN_BIOMES = Set.of(new ResourceLocation("forest"), new ResourceLocation("stony_shore"),
			...
			new ResourceLocation("flower_forest"), new ResourceLocation("bamboo_jungle"), new ResourceLocation("dark_forest"),
			new ResourceLocation("plains"), new ResourceLocation("savanna"), new ResourceLocation("stony_peaks"), new ResourceLocation("meadow"),
			new ResourceLocation("old_growth_spruce_taiga"), new ResourceLocation("savanna_plateau"), new ResourceLocation("dripstone_caves"),
			new ResourceLocation("taiga"), new ResourceLocation("jagged_peaks"), new ResourceLocation("swamp"),
			new ResourceLocation("eroded_badlands"), new ResourceLocation("old_growth_birch_forest"), new ResourceLocation("windswept_hills"),
			new ResourceLocation("old_growth_pine_taiga"), new ResourceLocation("beach"), new ResourceLocation("wooded_badlands"),
			new ResourceLocation("windswept_savanna"), new ResourceLocation("windswept_forest"), new ResourceLocation("jungle"),
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.MONSTER)
					.add(new MobSpawnSettings.SpawnerData(EnemyexpansionModEntities.TARANTULA.get(), 50, 1, 1));
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		TarantulaEntityIsHurtProcedure.execute(this);
	...
	public static void init() {
		...
		DungeonHooks.addDungeonMob(EnemyexpansionModEntities.TARANTULA.get(), 180);
	}
