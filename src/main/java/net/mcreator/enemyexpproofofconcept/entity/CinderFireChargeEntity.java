...
public class CinderFireChargeEntity extends AbstractArrow implements ItemSupplier {
	public CinderFireChargeEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(EnemyexpansionModEntities.CINDER_FIRE_CHARGE.get(), world);
	}

	public CinderFireChargeEntity(EntityType<? extends CinderFireChargeEntity> type, Level world) {
		super(type, world);
	}

	public CinderFireChargeEntity(EntityType<? extends CinderFireChargeEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public CinderFireChargeEntity(EntityType<? extends CinderFireChargeEntity> type, LivingEntity entity, Level world) {
	...
	public void tick() {
		super.tick();
		CinderFireChargeAntigravityProcedure.execute(this.level, this);
		if (this.inGround)
			this.discard();
	}
	...
	public static CinderFireChargeEntity shoot(LivingEntity entity, LivingEntity target) {
		CinderFireChargeEntity entityarrow = new CinderFireChargeEntity(EnemyexpansionModEntities.CINDER_FIRE_CHARGE.get(), entity, entity.level);
