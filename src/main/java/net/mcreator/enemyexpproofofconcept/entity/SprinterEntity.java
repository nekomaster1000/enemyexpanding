...
import net.mcreator.enemyexpproofofconcept.procedures.SprinterzombieEntityIsHurtProcedure;
...
public class SprinterEntity extends Zombie implements IAnimatable {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(EnemyexpansionModEntities.SPRINTER.get(), 75, 1, 1));
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, LadybugEntity.class, false, false));
	...
	public static void init() {
		...
		DungeonHooks.addDungeonMob(EnemyexpansionModEntities.SPRINTER.get(), 180);
	}
