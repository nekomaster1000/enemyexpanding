...
public class SluggerEntity extends Zombie implements IAnimatable {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(EnemyexpansionModEntities.SLUGGER.get(), 50, 1, 1));
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		SluggerzombieEntityIsHurtProcedure.execute(this.level, this, source.getEntity());
