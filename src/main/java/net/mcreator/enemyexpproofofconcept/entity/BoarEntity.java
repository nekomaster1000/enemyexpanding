...
import net.mcreator.enemyexpproofofconcept.procedures.BoarSpawningProcedure;
...
public class BoarEntity extends Animal implements IAnimatable {
	...
	private static final Set<ResourceLocation> SPAWN_BIOMES = Set.of(new ResourceLocation("snowy_plains"), new ResourceLocation("old_growth_pine_taiga"), new ResourceLocation("taiga"), new ResourceLocation("snowy_taiga"),
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "boar");
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		BoarEntity retval = EnemyexpansionModEntities.BOAR.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return List.of(Items.POTATO, Items.CARROT, Items.BEETROOT).contains(stack.getItem());
	}
	...
	public static void init() {
		SpawnPlacements.register(EnemyexpansionModEntities.BOAR.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
			return BoarSpawningProcedure.execute(world, x, y, z);
		});
	}
