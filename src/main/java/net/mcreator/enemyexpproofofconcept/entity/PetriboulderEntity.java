...
public class PetriboulderEntity extends Monster implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public PetriboulderEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EnemyexpansionModEntities.PETRIBOULDER.get(), world);
	}

	public PetriboulderEntity(EntityType<PetriboulderEntity> type, Level world) {
		super(type, world);
		xpReward = 15;
		setNoAi(false);
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(PetriboulderEntity.RemovalReason.KILLED);
		}
	}
