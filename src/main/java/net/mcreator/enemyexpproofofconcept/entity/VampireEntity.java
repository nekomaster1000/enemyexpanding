...
import net.mcreator.enemyexpproofofconcept.procedures.VampireSpawningProcedure;
import net.mcreator.enemyexpproofofconcept.procedures.VampireSpawnProcedure;
import net.mcreator.enemyexpproofofconcept.procedures.VampireSlayingProcedure;
...
public class VampireEntity extends Monster implements IAnimatable {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(EnemyexpansionModEntities.VAMPIRE.get(), 30, 1, 1));
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		VampireSlayingProcedure.execute(source.getEntity());
	}
	...
	public static void init() {
		SpawnPlacements.register(EnemyexpansionModEntities.VAMPIRE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			...
			int y = pos.getY();
			int z = pos.getZ();
			return VampireSpawningProcedure.execute(world, x, y, z);
		});
		DungeonHooks.addDungeonMob(EnemyexpansionModEntities.VAMPIRE.get(), 180);
	}
