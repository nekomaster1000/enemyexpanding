...
import net.mcreator.enemyexpproofofconcept.procedures.LadybugZombificationProcedure;
import net.mcreator.enemyexpproofofconcept.procedures.LadybugHealingGooBestowingProcedure;
import net.mcreator.enemyexpproofofconcept.procedures.LadybugFallsProcedure;
...
public class LadybugEntity extends Monster implements IAnimatable {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(EnemyexpansionModEntities.LADYBUG.get(), 100, 1, 1));
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, ZadybugEntity.class, (float) 6, 1.3, 1));
		this.goalSelector.addGoal(2, new TemptGoal(this, 1, Ingredient.of(Items.SPIDER_EYE), false));
		...
		this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, Spider.class, false, false));
	...
	public boolean causeFallDamage(float l, float d, DamageSource source) {
		LadybugFallsProcedure.execute(this);
	...
	public void die(DamageSource source) {
		super.die(source);
		LadybugZombificationProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), source.getEntity());
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		LadybugHealingGooBestowingProcedure.execute(world, x, y, z, entity, sourceentity, itemstack);
		return retval;
	}
