...
public class GhoulEntity extends Monster implements IAnimatable {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(EnemyexpansionModEntities.GHOUL.get(), 50, 1, 1));
	}

	public GhoulEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EnemyexpansionModEntities.GHOUL.get(), world);
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, GlowSquid.class, (float) 6, 1, 1.2));
		this.goalSelector.addGoal(2, new RemoveBlockGoal(Blocks.LANTERN, this, 1.2, (int) 3));
		this.goalSelector.addGoal(3, new RemoveBlockGoal(Blocks.TORCH, this, 1.2, (int) 3));
	...
	public boolean hurt(DamageSource source, float amount) {
		GhoulHurtProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this, source.getEntity());
