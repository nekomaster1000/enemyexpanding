...
public class DragonflyEntity extends Monster implements IAnimatable {
	...
	public DragonflyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EnemyexpansionModEntities.DRAGONFLY.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				Random random = DragonflyEntity.this.getRandom();
		...
		this.targetSelector.addGoal(8, new NearestAttackableTargetGoal(this, Player.class, false, false) {
			...
			public boolean canUse() {
				double x = DragonflyEntity.this.getX();
				double y = DragonflyEntity.this.getY();
	...
	public boolean hurt(DamageSource source, float amount) {
		DragonflyDodgePatternProcedure.execute(this.level, this, source.getEntity());
	...
	public void baseTick() {
		super.baseTick();
		DragonflyErraticFlightProcedure.execute(this);
