...
public class PetricrawlerEntity extends Monster implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public PetricrawlerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EnemyexpansionModEntities.PETRICRAWLER.get(), world);
	}

	public PetricrawlerEntity(EntityType<PetricrawlerEntity> type, Level world) {
		super(type, world);
		xpReward = 10;
		setNoAi(false);
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(PetricrawlerEntity.RemovalReason.KILLED);
		}
	}
