...
import net.mcreator.enemyexpproofofconcept.procedures.PropellerTickProcedure;
import net.mcreator.enemyexpproofofconcept.procedures.PropellerStruckByLightningProcedure;
...
public class PropellerEntity extends Skeleton implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(PropellerEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(PropellerEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(PropellerEntity.class, EntityDataSerializers.STRING);
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(EnemyexpansionModEntities.PROPELLER.get(), 40, 1, 1));
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "propeller");
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, Player.class, (float) 6, 1.2, 1.4));
	}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.copper.place"));
	}

	@Override
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.lantern.step")), 0.15f, 1);
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ui.stonecutter.take_result"));
	}
	...
	public void thunderHit(ServerLevel serverWorld, LightningBolt lightningBolt) {
		...
		PropellerStruckByLightningProcedure.execute(this);
	}
	...
	public void baseTick() {
		super.baseTick();
		PropellerTickProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
