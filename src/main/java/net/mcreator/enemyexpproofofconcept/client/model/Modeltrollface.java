...
public class Modeltrollface<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("enemyexpansion", "modeltrollface"), "main");
	public final ModelPart trolled;
