...
public class Modelmeatman<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rightArm_r1 = head.addOrReplaceChild("rightArm_r1",
				CubeListBuilder.create().texOffs(52, 2).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -2.0F, -2.0F, -0.7854F, 0.0F, 0.7854F));
		PartDefinition leftArm_r1 = head
				.addOrReplaceChild(
						"leftArm_r1", CubeListBuilder.create().texOffs(52, 2).mirror()
		...
		PartDefinition rightLeg_r1 = head.addOrReplaceChild("rightLeg_r1",
				CubeListBuilder.create().texOffs(36, 2).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, -2.0F, 2.0F, 0.7854F, 0.0F, 0.7854F));
		PartDefinition leftLeg_r1 = head
				.addOrReplaceChild(
						"leftLeg_r1", CubeListBuilder.create().texOffs(36, 2).mirror()
								.addBox(-1.0F, 0.0F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
						PartPose.offsetAndRotation(1.0F, -2.0F, 2.0F, 0.7854F, 0.0F, -0.7854F));
