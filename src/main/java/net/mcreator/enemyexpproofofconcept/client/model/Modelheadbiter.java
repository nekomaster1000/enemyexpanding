...
public class Modelheadbiter<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leftarm2 = botharms.addOrReplaceChild("leftarm2",
				CubeListBuilder.create().texOffs(33, 39).addBox(-1.0F, -0.8311F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(41, 39)
		...
		PartDefinition rightarm2 = botharms.addOrReplaceChild("rightarm2",
				CubeListBuilder.create().texOffs(33, 39).mirror().addBox(-1.0F, -0.8311F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(41, 39).mirror().addBox(-1.0F, -0.8311F, 1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(-5.0F, -0.5F, 0.0F, -1.5708F, 0.0F, -0.0873F));
		PartDefinition head2 = all2.addOrReplaceChild("head2",
				CubeListBuilder.create().texOffs(0, 32).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.02F)),
		...
		PartDefinition leftleg_r1 = leftleg2.addOrReplaceChild(
				"leftleg_r1", CubeListBuilder.create().texOffs(33, 33).mirror()
		...
		PartDefinition rightleg_r1 = rightleg2.addOrReplaceChild("rightleg_r1",
				CubeListBuilder.create().texOffs(33, 33).addBox(-3.0F, 0.0F, -1.0F, 4.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition rightwing = rightear
				.addOrReplaceChild(
						"rightwing", CubeListBuilder.create().texOffs(1, 32).mirror()
		...
		PartDefinition leftear = head2.addOrReplaceChild("leftear", CubeListBuilder.create(),
				PartPose.offsetAndRotation(4.0F, -4.0F, -2.0F, 0.3927F, 0.0F, 0.0F));
		PartDefinition leftwing = leftear.addOrReplaceChild("leftwing",
				CubeListBuilder.create().texOffs(1, 32).addBox(0.0F, -5.0F, 0.0F, 0.0F, 13.0F, 19.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.5672F, 0.0F));
