...
public class Modelcinderhelmet<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("enemyexpansion", "modelcinderhelmet"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.3F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.3F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition helmet = head.addOrReplaceChild("helmet",
				CubeListBuilder.create().texOffs(17, 28).addBox(-4.0F, 0.9F, -1.8F, 8.0F, 2.0F, 1.0F, new CubeDeformation(0.32F)).texOffs(23, 24)
