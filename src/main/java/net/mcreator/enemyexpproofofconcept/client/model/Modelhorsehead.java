...
public class Modelhorsehead<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition all = partdefinition.addOrReplaceChild("all",
				CubeListBuilder.create().texOffs(32, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.1F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition reignsleft_r1 = all.addOrReplaceChild("reignsleft_r1",
				CubeListBuilder.create().texOffs(46, 24).mirror().addBox(0.0F, 0.1F, -8.0F, 1.0F, 2.0F, 8.0F, new CubeDeformation(0.1F)).mirror(false)
		...
		PartDefinition horsehead = all.addOrReplaceChild("horsehead",
				CubeListBuilder.create().texOffs(0, 8).addBox(-4.5F, -8.0F, -7.0F, 9.0F, 8.0F, 11.0F, new CubeDeformation(0.0F)).texOffs(41, 17)
						.addBox(-1.49F, -8.0F, 4.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.01F)).texOffs(0, 28)
						.addBox(-3.0F, -7.0F, -13.4F, 6.0F, 7.0F, 7.0F, new CubeDeformation(0.01F)).texOffs(26, 28).addBox(-3.0F, -7.0F, -13.4F, 6.0F,
								7.0F, 7.0F, new CubeDeformation(0.11F)),
				PartPose.offsetAndRotation(0.0F, -5.75F, 1.0F, 0.5236F, 0.0F, 0.0F));
		PartDefinition earleft = horsehead
				.addOrReplaceChild(
						"earleft", CubeListBuilder.create().texOffs(0, 12).mirror()
		...
		PartDefinition earright = horsehead.addOrReplaceChild("earright",
				CubeListBuilder.create().texOffs(0, 12).addBox(-1.5F, -4.0F, 0.0F, 3.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, -8.0F, 2.0F, 0.0F, 0.0F, -0.1745F));
