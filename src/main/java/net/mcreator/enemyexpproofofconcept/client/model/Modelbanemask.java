...
public class Modelbanemask<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition banehead = partdefinition.addOrReplaceChild("banehead",
				CubeListBuilder.create().texOffs(32, 48).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.2F)).texOffs(40, 38)
		...
		PartDefinition earl = banehead.addOrReplaceChild("earl",
				CubeListBuilder.create().texOffs(0, 52).addBox(-1.01F, -6.9424F, 0.3243F, 2.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.0F, -4.7782F, -2.1924F));
		PartDefinition earr = banehead.addOrReplaceChild(
				"earr", CubeListBuilder.create().texOffs(0, 52).mirror()
		...
		PartDefinition lowerjaw = banehead.addOrReplaceChild("lowerjaw",
				CubeListBuilder.create().texOffs(17, 42).addBox(-3.0F, -0.95F, -4.85F, 6.0F, 1.0F, 4.0F, new CubeDeformation(0.02F)).texOffs(2, 57)
