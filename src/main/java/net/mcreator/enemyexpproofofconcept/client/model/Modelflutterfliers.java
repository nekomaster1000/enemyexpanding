...
public class Modelflutterfliers<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("enemyexpansion", "modelflutterfliers"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition mainguyleftwing = mainguy.addOrReplaceChild("mainguyleftwing",
				CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, -18.0F, 0.0F, 20.0F, 40.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 1.0F, 0.0F, -0.3927F, 0.0F));
		PartDefinition mainguyrightwing = mainguy.addOrReplaceChild(
				"mainguyrightwing", CubeListBuilder.create().texOffs(0, 0).mirror()
