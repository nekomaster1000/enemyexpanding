...
public class Modelhuntsman<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leftLeg = partdefinition.addOrReplaceChild("leftLeg", CubeListBuilder.create().texOffs(9, 18).mirror()
				.addBox(-1.0F, -2.0F, -1.0F, 2.0F, 16.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(2.0F, 10.0F, 0.0F));
		PartDefinition rightLeg = partdefinition.addOrReplaceChild("rightLeg",
				CubeListBuilder.create().texOffs(9, 18).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 16.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 10.0F, 0.0F));
		PartDefinition leftArm = partdefinition.addOrReplaceChild("leftArm",
				CubeListBuilder.create().texOffs(0, 43).mirror().addBox(0.0F, -3.0F, -2.0F, 3.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(0, 18).mirror().addBox(0.0F, -2.0F, -1.0F, 2.0F, 16.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 36)
						.mirror().addBox(-0.5F, 6.5F, -2.1F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.2F)).mirror(false).texOffs(15, 40).mirror()
						.addBox(-0.5F, 7.5F, -2.1F, 3.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition rightArm = partdefinition.addOrReplaceChild("rightArm",
				CubeListBuilder.create().texOffs(0, 43).addBox(-2.0F, -3.0F, -2.0F, 3.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 18)
		...
		PartDefinition bow = rightArm.addOrReplaceChild("bow",
				CubeListBuilder.create().texOffs(25, 6).addBox(-0.5F, -0.3431F, 9.6569F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(25, 6)
		...
		PartDefinition cape_r1 = cape.addOrReplaceChild("cape_r1",
				CubeListBuilder.create().texOffs(38, 52).addBox(-5.0F, -0.2F, -0.98F, 10.0F, 11.0F, 1.0F, new CubeDeformation(0.1F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.096F, 0.0F, 0.0F));
		PartDefinition bb_main = partdefinition.addOrReplaceChild(
				"bb_main", CubeListBuilder.create().texOffs(0, 52).addBox(-5.0F, -30.2F, -3.0F, 10.0F, 4.0F, 6.0F, new CubeDeformation(0.0F))
						.texOffs(40, 0).addBox(-4.0F, -30.0F, -2.0F, 8.0F, 14.0F, 4.0F, new CubeDeformation(0.0F)),
