...
public class HuntsmanPunchItem extends Item {
	public HuntsmanPunchItem() {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				HuntsmanPunchEntity entityarrow = HuntsmanPunchEntity.shoot(world, entity, world.getRandom(), 1f, 4, 5);
