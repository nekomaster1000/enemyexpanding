...
import net.mcreator.enemyexpproofofconcept.procedures.PheromoneThrownProcedure;
import net.mcreator.enemyexpproofofconcept.entity.PheromoneProjectileEntity;

public class PheromoneProjectileItem extends Item {
	public PheromoneProjectileItem() {
