...
public class SlimeballThrowItem extends Item {
	public SlimeballThrowItem() {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				SlimeballThrowEntity entityarrow = SlimeballThrowEntity.shoot(world, entity, world.getRandom(), 1f, 3, 1);
