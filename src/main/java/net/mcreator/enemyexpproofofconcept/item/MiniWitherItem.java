...
public abstract class MiniWitherItem extends ArmorItem {
	public MiniWitherItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(Blocks.WITHER_SKELETON_SKULL));
			}
	...
	public static class Helmet extends MiniWitherItem {
		public Helmet() {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(Component.literal("Attacks inflict a brief bout of Wither III"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "enemyexpansion:textures/entities/miniwither.png";
		}
	}
}
