...
public abstract class SpectralItem extends ArmorItem {
	public SpectralItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public int getDefenseForSlot(EquipmentSlot slot) {
				return new int[]{0, 0, 3, 1}[slot.getIndex()];
			}
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(Items.BLACK_DYE));
			}
	...
	public static class Helmet extends SpectralItem {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(Component.literal("Attacks inflict momentary Blindness"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "enemyexpansion:textures/models/armor/spectral__layer_1.png";
		}
	}
	...
	public static class Chestplate extends SpectralItem {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(Component.literal("Attacks inflict momentary Weakness"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "enemyexpansion:textures/entities/spectral.png";
		}
	}
}
