...
public abstract class MeatheadArmorItem extends ArmorItem {
	...
	public static class Helmet extends MeatheadArmorItem {
			...
			consumer.accept(new IItemRenderProperties() {
				...
				public HumanoidModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("head", new meathat(Minecraft.getInstance().getEntityModels().bakeLayer(meathat.LAYER_LOCATION)).head, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "body",
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent("Gain 5 seconds of Speed II; Strength II; and Hunger II when hurt"));
			list.add(new TextComponent("Can be cooked into a meatball"));
		}
