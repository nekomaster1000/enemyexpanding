...
public class GallantSwingsItem extends Item {
	public GallantSwingsItem() {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				GallantSwingsEntity entityarrow = GallantSwingsEntity.shoot(world, entity, world.getRandom(), 1f, 14, 1);
