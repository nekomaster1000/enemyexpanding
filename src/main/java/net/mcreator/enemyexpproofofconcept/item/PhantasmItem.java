...
public abstract class PhantasmItem extends ArmorItem {
	...
	public static class Helmet extends PhantasmItem {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(Component.literal("Provides Night Vision when worn in the dark"));
		}
	...
	public static class Chestplate extends PhantasmItem {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(Component.literal("Crouching in the dark provides a Super Jump and Slow Falling"));
		}
